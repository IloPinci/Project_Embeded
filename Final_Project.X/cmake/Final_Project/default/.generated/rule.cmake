...
set(PACK_REPO_PATH "C:/Users/boli/.mchp_packs" CACHE PATH "Path to the root of a pack repository.")
...
function(Final_Project_default_default_XC16_assemble_rule target)
    ...
    target_include_directories(${target}
        PRIVATE "${CMAKE_CURRENT_SOURCE_DIR}/../../../../libraries"
...
function(Final_Project_default_link_rule target)
    ...
    target_compile_definitions(${target}
        ...
        PRIVATE "XPRJ_default=default")
    target_include_directories(${target} PRIVATE "${CMAKE_CURRENT_SOURCE_DIR}/../../../../libraries")
endfunction()
